...
void preguntarOrden(int* orden)
{
	pedirNumeros(orden, "\nOrdenar de manera:\n"
					"1) ascendente\n"
					"2) descendente\n", "Error, elija una opcion valida", "Error, elija una opcion entre 1 y 2", 2, 1);
}
void preguntarSort(int* sort)
{
	pedirNumeros(sort, "\nTipo de ordenamiento:\n"
			...
			"Elija una opcion: ", "Error, opcion invalida", "Error, elija una opcion valida entre 1 y 2", 2, 1);
}
