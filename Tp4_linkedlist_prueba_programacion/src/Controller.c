...
int controller_listarPorEstado(LinkedList* pArrayListPassenger, int listaTipo)
{
	...
	if(pArrayListPassenger != NULL)
	{
		...
		{
			case 2:
				listaFiltrada = ll_filter(pArrayListPassenger, Passenger_filtrarPorEstadoEnVuelo);
				break;
			case 3:
				listaFiltrada = ll_filter(pArrayListPassenger, Passenger_filtrarPorEstadoEnHorario);
				break;
			case 4:
				listaFiltrada = ll_filter(pArrayListPassenger, Passenger_filtrarPorEstadoDemorado);
				break;
			case 5:
				listaFiltrada = ll_filter(pArrayListPassenger, Passenger_filtrarPorEstadoAterrizado);
				break;
		}
		...
		if(listaFiltrada != NULL)
		{
			...
			if(len >= 1)
			{
				...
				for(int i =0; i<len; i++ )
				{
					pasajeroAux = ll_get(listaFiltrada, i);
					Passenger_print(pasajeroAux);
				}
				printf("==============================================================================================================\n");
			}
			else
...
int controller_ListPassenger(LinkedList* pArrayListPassenger)
{
	...
	preguntarTipoDeLista(&tipoLista);
	...
	{
		if(controller_listarPorEstado(pArrayListPassenger, tipoLista))
		{
			printf("Fin de la lista.\n");
			retorno = 1;
		}
