...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
	...
	if(this!=NULL && nodeIndex>=0)
	{
		...
		else
		{
			...
			if(nodeIndex < len)
			{
				pocisionNodo = getNode(this, nodeIndex);
				nuevoNodo->pNextNode = pocisionNodo;
				this->size++;
				returnAux =0;
			}
			else
			{
				...
				{
					this->size++;
					pocisionNodo = getNode(this, nodeIndex-1);
					nuevoNodo->pNextNode=NULL;
					returnAux = 0;
				}
			}

			pocisionNodo->pNextNode = nuevoNodo;
		}
	}
	return returnAux;
}
...
void* ll_get(LinkedList* this, int index)
{
    void* returnAux = NULL;
    int len;
    Node* nodoDelElemento;

    len=ll_len(this);

	if(this != NULL && index >= 0 && index < len)
	{
		nodoDelElemento = getNode(this,index);
		returnAux = nodoDelElemento->pElement;
	}
    return returnAux;
}
...
int ll_indexOf(LinkedList* this, void* pElement)
{
	...
	if(this!=NULL)
	{
		for(int i = 0; i < len; i++)
		{
			elementoIgual = ll_get(this,i);

			if(elementoIgual == pElement)
			{
				returnAux = i;
				break;
			}
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
	...
	lenListaDos=ll_len(this2);

	if(this!=NULL && this2!=NULL)
	{
		returnAux =1;

		for(int i = 0; i < lenListaDos; i++)
		{
